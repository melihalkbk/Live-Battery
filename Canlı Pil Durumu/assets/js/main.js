    ...
    navigator.getBattery().then((batt) =>{
        updateBattery = () =>{
            ...
            if(level == 100){ /* We validate if the battery is full */
                batteryStatus.innerHTML = `Pil Tam <i class="ri-battery-2-fill green-color"></i>`
                ...
                batteryStatus.innerHTML = `Pil Şarj Oluyor... <i class="ri-flashlight-line animated-green"></i>`
            }
